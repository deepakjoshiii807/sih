import { Home, Compass, GraduationCap, Briefcase, Users, UserPlus } from "lucide-react";
...
const navItems = [
  ...
  { name: "Login", url: "/login", icon: Users, isAction: true },
  { name: "Sign Up", url: "/login", icon: UserPlus, isAction: true, highlight: true },
];
