        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            <svg
              width="377"
              height="368"
              className="w-105 fill-neutral-100 absolute -bottom-16 group-hover:rotate-180 duration-[2000ms] ease-in -right-16"
              viewBox="0 0 377 368"
              fill="none"
          ...
          >
            ...
            <h4 className="text-xl font-bold leading-tight">AI Matching</h4>
            <p className="text-xs text-gray-500 font-mono">Semantic Skill Engine V2</p>
          </motion.div>

          {/* CTA card — Join the community */}
          <motion.div
            custom={3}
            variants={fadeUp}
            initial="hidden"
